		...
		*/
		$.ajax({
			...
			success:function(result)
			{
				...
				if(result==="yes")
				{
					location.href="../post/list.do?page="+page
				}
				else
				{
					alert("비밀번호가 틀립니다!!")
             ...
             <table class="table">
              ...
              <tr>
               <td colspan="4" class="text-right">
                <a href="../post/update.do?no=${vo.postId }&page=${page}" class="btn btn-mint btn-xs">수정</a>
                <span class="btn btn-pink btn-xs" id="delSpan">삭제</span>
                <a href="../post/list.do?page=${page }" class="btn btn-mint btn-xs">목록</a>
               </td>
              </tr>
                ...
                <td colspan="4" class="text-right">
                 비밀번호:<input type=password name=pwd
                   ...
                   <input type=button class="btn-mint btn-sm"
                    id="delBtn" value="삭제"
                    data-no="${vo.postId }" data-page="${page }"
                   >
                </td>
              </tr>
             </table>
		            ...
		            <div class="col-md-4 text-right">
		              <c:if test="${sessionScope.id!=null && rvo.msg!='관리자가 삭제한 댓글입니다'}">
		               <c:if test="${sessionScope.id==rvo.id}">
		                ...
		                <a href="../reply/reply_delete.do?no=${rvo.no }" class="btn btn-xs btn-warning">삭제</a>
		               </c:if>
